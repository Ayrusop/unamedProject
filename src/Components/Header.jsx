  ...
  return (
    <div className="header">
      ...
      <div className={`nav-items ${menuOpen ? 'show-nav' : ''}`} id="nav-container">
        ...
        <div className="nav">
        <Link to='/' style={{ textDecoration: 'none' }} className='header-nav'><span className="nav-link">Home</span></Link> 
        </div>
        <div className="nav">
        ...
        <div className="nav">
        <Link to='/gallery' style={{ textDecoration: 'none' }}><span className="nav-link">Gallery</span></Link> 
          {/* <h3>Contact Us</h3> */}
        </div>
        <div className="nav">
        <Link to='/profile'  style={{ textDecoration: 'none' }}><button className='glb-btn m-2'>Profile</button></Link> 
        </div>
      </div>
