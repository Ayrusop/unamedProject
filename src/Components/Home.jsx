...
const Home = () => {
    ...
    return (
        // Smart way to Build and Design your dream Home
        <Fragment>
            <MetaData title={"Discover | SVARG | Smart way to Build and Design your dream Home"} />
            <section className="banner container-fluid mt-3">
                <div className="container mt-5 align-items-center d-flex flex-column flex-lg-row main-sec">
                    ...
                    <div className="col-lg-5 main-text-area">
                        ...
                        <Link className='link-tag' to='./aboutus'>
                        <button className='glb-btn m-2 hide-on-mobile'>Learn More</button>
                        </Link>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="px-3 px-md-5 main-text-area">
                                <h2  className='mt-3'>Explore & Learn more About Us</h2>
                                ...
                                {/* <Link className='link-tag' to='./contact'>
                                    <button className='glb-btn hide-on-mobile'>
                                        Explore
                                    </button>
                                </Link> */}
                ...
                <section>
                    <div className="row mt-5 no-gutters"> {/* Use no-gutters to remove padding */}
                        <div className="col-sm d-flex justify-content-center"> {/* Center align the images */}
                            <img src={centerImg1} alt="centerImg1" className="center-image want-hover" />
                        </div>
                        <div className="col-sm d-flex justify-content-center">
                            <img src={centerImg2} alt="centerImg2" className="center-image want-hover" />
                        </div>
                        <div className="col-sm d-flex justify-content-center">
                            <img src={centerImg3} alt="centerImg3" className="center-image want-hover" />
                        </div>
                    </div>
                </section>
